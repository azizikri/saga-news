...
function submit() {
    form.post(route('articles.store'), {forceFormData: true})
}
    ...
    <section>
        ...
        <form @submit.prevent="submit()" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">WEBP, PNG, JPG or GIF (MAX. 800x400px).</p>
